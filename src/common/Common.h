...
{
    SEC_PLAYER					= 0,
    SEC_DONOR					= 1,	//SEC_MODERATOR             = 1,
    SEC_BUGTRACKER				= 2,	//SEC_GAMEMASTER            = 2,
	SEC_MODERATOR				= 3,	//SEC_CONFIRMED_GAMEMASTER  = 3,
	SEC_TRAIL_GM				= 4,	//SEC_REALM_LEADER          = 4,
	SEC_GAMEMASTER				= 5,
    SEC_ADMINISTRATOR			= 6,
    SEC_DEVELOPER				= 7,	//SEC_DONOR                 = 7,
