...
enum spells
{
    ...
    BERSERK_BUFF = 160137,
    BERSERK_BUFF_H = 61715,
};

class raid_n_h_buff_npc : public CreatureScript
{
public:
    raid_n_h_buff_npc() : CreatureScript("raid_n_h_buff_npc") {}
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        case CLASS_WARRIOR:
        {
            ...
            player->AddAura(BERSERK_BUFF_H, player);
