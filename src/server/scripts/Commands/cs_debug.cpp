...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        ...
        {
            { "cinematic",      SEC_BUGTRACKER,      false, &HandleDebugPlayCinematicCommand,   "", NULL },
            { "movie",          SEC_BUGTRACKER,      false, &HandleDebugPlayMovieCommand,       "", NULL },
            { "sound",          SEC_BUGTRACKER,      false, &HandleDebugPlaySoundCommand,       "", NULL },
        ...
        static ChatCommand debugSendCommandTable[] =
        {
            ...
            { "compress",       SEC_DEVELOPER,  false, &HandleDebugSendCompressCommand,       "", NULL },
            ...
            { "multi",          SEC_DEVELOPER,  false, &HandleDebugSendMultCommand,           "", NULL },
            ...
            { "sendLfgListStatus", SEC_BUGTRACKER,  false, &HandleDebugSendLFGListStatusUpdate, "", NULL },
        ...
        {
            { "generatemissions",   SEC_DEVELOPER,  false, &HandleHenerateMissionsCommand,      "", nullptr },
            { nullptr,              SEC_PLAYER,     false, nullptr,                             "", nullptr }
        };
        
        static ChatCommand debugCommandTable[] =
        {
            { "anim",           SEC_BUGTRACKER,     false, &HandleDebugAnimCommand,            "", NULL },
            ...
            { "backward",       SEC_BUGTRACKER,   false, &HandleDebugMoveBackward,           "", NULL },
            { "bg",             SEC_BUGTRACKER,   false, &HandleDebugBattlegroundCommand,    "", NULL },
            { "ashran",         SEC_GAMEMASTER,   false, &HandleDebugAshranCommand,          "", NULL },
            { "lfg",            SEC_GAMEMASTER,   false, &HandleDebugLFGCommand,             "", NULL},
            { "challenge",      SEC_GAMEMASTER,   false, &HandleDebugChallengeCommand,       "", NULL },
            ...
            { "getdynamicvalue",SEC_DEVELOPER,  false, &HandleDebugGetDynamicValueCommand, "", NULL },
            ...
            { "versality",      SEC_ADMINISTRATOR,   false, &HandleDebugModifyVersalityCommand, "", NULL },
            { "hostile",        SEC_GAMEMASTER,   false, &HandleDebugHostileRefListCommand,  "", NULL },
            { "itemexpire",     SEC_ADMINISTRATOR,  false, &HandleDebugItemExpireCommand,      "", NULL },
            { "jump",           SEC_BUGTRACKER,  false, &HandleDebugMoveJump,               "", NULL },
            ...
            { "los",            SEC_BUGTRACKER,      false, &HandleDebugLoSCommand,             "", NULL },
            ...
            { "phase",          SEC_BUGTRACKER,      false, &HandleDebugPhaseCommand,           "", NULL },
            { "play",           SEC_BUGTRACKER,      false, NULL,              "", debugPlayCommandTable },
            ...
            { "challengeloot",  SEC_GAMEMASTER,   false, &HandleDebugChallengeLootCommand,   "", NULL },
            { "group",          SEC_GAMEMASTER,   false, &HandleDebugGroupCommand,           "", NULL },
            { "pvpmystic",      SEC_ADMINISTRATOR, false, &HandleDebugPvpMysticCommand, "", NULL},
            ...
            { "setkillpoints",  SEC_ADMINISTRATOR,     false, &HandleDebugKillPointsCommand,      "", nullptr },
            { "abort",          SEC_ADMINISTRATOR,     false, &HandleDebugAbort,                  "", nullptr },
            { "exception",      SEC_ADMINISTRATOR,     false, &HandleDebugException,              "", nullptr },
            { NULL,             SEC_PLAYER,         false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "debug",          SEC_BUGTRACKER,      true,  NULL,                  "", debugCommandTable },
